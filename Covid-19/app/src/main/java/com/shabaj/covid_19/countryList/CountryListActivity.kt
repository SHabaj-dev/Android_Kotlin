package com.shabaj.covid_19.countryList
...
import com.shabaj.covid_19.countryList.model.CountryData
import com.shabaj.covid_19.countryList.model.CountryDataResponse
import com.shabaj.covid_19.countryList.viewmodel.CountryListViewModel
...
//        arrayList.add(PieEntry(CountryData.recoverd!!.toFloat(), 1))
        arrayList.add(PieEntry(countryData.deaths!!.toString().toFloat(), 2))
...
//        recovered_percentage.text = getFormattedNumber(countryData.recovered.toLong())
        death_percentage.text = getFormattedNumber(countryData.deaths.toString().toLong())
